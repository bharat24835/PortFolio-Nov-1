...
export default function HeroContent() {
  return (
    ...
    >
      ...
      >
        Building scalable applications with Next.js 15, React 19, and TypeScript.
        Passionate about optimizing performance, creating exceptional UX, and solving complex problems.
        Solved 960+ coding problems on LeetCode and GeeksForGeeks.
      </motion.p>
